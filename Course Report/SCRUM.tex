...
They are responsible for making sure that the team adhere to the Scrum guidelines. They should not be seen as the head of the group, but instead as the coach.
...
the development team. Within the team, the Product Owner acts as the client, although the client normally being an external actor.
The Product Owner is the person who owns and controls the development of the software with the help of the backlog,
prioritizing features and generally the one who is supposed to give you the direction during the sprint planning and at the demos.
...
broken down into tasks and each task is the smallest unit of work to implement.
...
To improve throughout the project it is important that everyone is honest and shares their opinion during the retrospective.
