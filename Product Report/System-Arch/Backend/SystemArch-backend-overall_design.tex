...
\begin{figure}
	\centering
\centerline{\includegraphics[width=1.4\textwidth]{./img/process_hierarchy.png}}
...
\begin{figure}
	\centering
\centerline{\includegraphics[width=1.4\textwidth]{./img/seq_pub.png}}
...
\begin{figure}
	\centering
\centerline{\includegraphics[width=1.4\textwidth]{./img/backend_seq_diagram_GET.png}}
...
\begin{figure}
	\centering
\centerline{\includegraphics[width=1.4\textwidth]{./img/backend_seq_diagram_SEARCH.png}}
