...
In order to face these problems Information-Centric Networking (ICN) was introduced, see \cite{ghodsietal}.
...
as proposed in \cite{netinf} (see \sect{netinf}), one out of four concepts that realize ICN. The software was
